...
export function VisualSettings() {
  ...
  return (
    <div className="fixed left-1/2 bottom-[45px] -translate-x-1/2 z-40 select-none pointer-events-none">
      <div className="hud-panel flex items-center gap-5 font-mono text-[9px] tracking-wider uppercase animate-slide-in-bottom pointer-events-auto">
        ...
        <button
          ...
          className={`filter-btn !text-[8px] !px-3 !py-0.5 !font-bold ${isAboutOpen ? 'active' : ''}`}
        >
          SOBRE
        </button>
      </div>
